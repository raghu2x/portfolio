...
import { ArrowUpRight, ExternalLink, Code, Monitor, ShoppingBag, Layers } from "lucide-react";
...
const Projects: React.FC = () => {
  ...
  return (
    <section id="projects" className="section py-24 relative" style={{ "--section-index": "2" } as React.CSSProperties}>
      <div className="absolute top-0 right-0 -z-10 h-[30rem] w-[30rem] rounded-full bg-primary/5 blur-[100px]" />
      ...
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center lg:max-w-none">
          ...
          >
            Explore a selection of my professional projects showcasing my skills in Vue.js, TypeScript, and frontend development.
          </motion.p>
            ...
            {filteredProjects.length > 0 ? (
              filteredProjects.map((project) => (
                <motion.div
                  ...
                  animate="visible"
                  layout
                  className="group relative overflow-hidden rounded-xl glass-card transition-all duration-300 hover:translate-y-[-5px] hover:shadow-lg hover:shadow-primary/10"
                >
