...
const About: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="absolute top-1/2 left-0 -z-10 h-[30rem] w-[30rem] -translate-y-1/2 rounded-full bg-primary/5 blur-[100px]" />
        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-16">
            <div>
              ...
              >
                <p>
                  Hello! I'm Raghvendra Yadav, a passionate fullstack developer with a knack for
                  creating elegant solutions to complex problems. My journey in
                  web development began over 5 years ago, and I've been in love
                  with the craft ever since.
                </p>
                <p>
                  I specialize in building modern web applications using the
                  latest technologies. My approach combines technical expertise
                  with creative problem-solving to deliver solutions that meet
                  business goals and exceed user expectations.
                </p>
                <p>
